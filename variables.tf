...
variable "namespace" {
  type        = string
  default     = "gitlab-runner"
  description = "The K8s namespace in which the gitlab-runner service account has been created"
}

variable "settings" {
  type        = map(any)
  default     = {}
  description = "Additional helm sets which will be passed to the Helm chart values, see https://hub.helm.sh/charts/stable/gitlab-runner"
}

variable "values" {
  type        = string
  default     = ""
  description = "Additional yaml encoded values which will be passed to the Helm chart, see https://hub.helm.sh/charts/stable/gitlab-runner"
}
...
variable "irsa_role_name_prefix" {
  ...
  description = "The IRSA role name prefix for gitlab-runner"
}
...
# ================ gitlab runner variables (required) ================

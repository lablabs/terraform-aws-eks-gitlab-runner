...
[![pre-commit](https://github.com/lablabs/terraform-aws-eks-gitlab-runner/actions/workflows/pre-commit.yaml/badge.svg)](https://github.com/lablabs/terraform-aws-eks-gitlab-runner/actions/workflows/pre-commit.yaml)
...
| <a name="input_gitlab_url"></a> [gitlab\_url](#input\_gitlab\_url) | Gitlab URL | `string` |
...
| <a name="input_runner_registration_token"></a> [runner\_registration\_token](#input\_runner\_registration\_token) | The Registration Token for adding new Runners to the GitLab Server. This must be retrieved from your GitLab Instance | `string` |
